...
#import test	#Utkommenterad av Benjamin pga noModuleFoundException, verkar funka utan denna rad
import utils
import pandas as pd
import numpy as np
...
model_weights = os.path.join(model_folder, "trained_weights_stage_1.h5") #changed from trained_weights_final.h5
